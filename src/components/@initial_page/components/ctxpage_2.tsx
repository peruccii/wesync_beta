...
const ContextPageSecond = () => {
  return (
    <Section>
      <div className="conainer relative z-2">
      <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
    <div className="flex mx-auto text-center">
     <h2 className="text-[#A42F52] flex gap-1 font-bold" id="introducing">Simple and <h2 className="font-bold text-[#A42F52]">Fast</h2><Zap size={20} color="#A42F52" /></h2>
    </div>
    <h1 className="h1 mb-6 text-color-n-1 mt-3" id="title-1">
    Create your songs with just one URL
    </h1>
    <p className="body-1 max-w-3xl mx-auto mb-6 text-color-n-2 lg:mb-8" id="title-3">text text texttext text texttext text texttext text texttext text text   text text texttext text texttext text text</p>
   </div>
      </div>
