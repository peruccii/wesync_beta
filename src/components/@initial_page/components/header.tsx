...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50  border-b border-color-n-6 lg:bg-color-n-8/90 lg:backdrop-blur-sm ${
        openNavigation ? "bg-color-n-8" : "bg-color-n-8/90 backdrop-blur-sm"
      }`}
    >
